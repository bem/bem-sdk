...
test('should resolve tech in multiple entities depending on different from resolving tech in another ' +
    'entity', () => {
    var decl = [
            { block: 'A' },
            { block: 'B' }
...
test('should resolve tech dependency depending on tech different from resolving in another entity', () => {
    var decl = [{ block: 'A' }],
        deps = [
            {
                entity: { block: 'A' },
