...
bemNaming.bemStyle = {
    elemDelimiter: originalNaming._elemDelimiter,
    modDelimiter:  originalNaming._modDelimiter,
    wordPattern:   originalNaming._wordPattern,
    regex: originalNaming._regex
};
