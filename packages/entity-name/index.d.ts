...
export default class BemEntityName {
    ...
    readonly elem: ElementName | undefined;
    readonly mod: IModifier | undefined;
    readonly modName: ModifierName | undefined;
    readonly modVal: ModifierValue | undefined;
    readonly type: Type;
    ...
    valueOf(): IRepresentation;
    toJSON(): IRepresentation;
    toString(): string;
    inspect(depth: number, options: object): string;

    static create(obj: ICreateOptions | string): BemEntityName;
