...
test('should prioritise block-element natural ordering over recommended deps ordering', () => {
    var decl = [
            { block: 'A', elem: 'e' }
        ],
        deps = [
...
test('should prioritise block - boolean modifier natural ordering over recommended deps ordering', () => {
    var decl = [
...
test('should prioritise key-value modifier natural ordering over recommended deps ordering', () => {
    var decl = [
...
test('should prioritise element - element boolean modifier natural ordering over recommended deps ' +
    'ordering', () => {
    var decl = [
...
test('should prioritise boolean modifier - key-value modifier natural ordering over natural decl ' +
    'ordering', () => {
    var decl = [
            { block: 'A', modName: 'm', modVal: 'val' }
        ],
