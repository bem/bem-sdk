...
BEMNaming.prototype.stringify = function (obj) {
    ...
    if (obj.modName) {
        if (!obj.hasOwnProperty('modVal')) {
            throw new Error('The field `modVal` not specified. It is impossible to stringify BEM notation.');
        }
...
['validate', 'parse', 'stringify', 'isBlock', 'isElem', 'isBlockMod', 'isElemMod'].forEach(function (method) {
    bemNaming[method] = originalNaming[method].bind(originalNaming);
});
