...
describe('ordered-deps/ordering', () => {
    it('should place ordered entity from decl before entity depending on it', () => {
    ...
    it('should place ordered dependency before entity from decl depending on it', () => {
        const graph = new BemGraph();
    ...
    it('should place ordered dependency before multiple entities from decl depending on it', () => {
        const graph = new BemGraph();
    ...
    it('should keep decl ordering for entities unaffected by ordered dependency', () => {
        const graph = new BemGraph();
    ...
    it('should place ordered dependency before dependency depending on it', () => {
        const graph = new BemGraph();
    ...
    it('should place ordered dependency before several dependencies depending on it', () => {
        const graph = new BemGraph();
