  ...
  describe('ctx', () => {
    describe('context is block', () => {
      ...
      it('should extract blockMods with several modifiers and several values', () => {
        expect(
          p('m:theme=normal|action m:autoclosable=yes', { block: 'popup' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'theme' } },
          { block: 'popup', mod: { name: 'theme', val: 'normal' } },
    ...
    describe('context is elem of another block', () => {
      it('should extract block', () => {
        expect(p('b:popup')).to.eql([{ block: 'popup' }]);
      });

      it('should extract block with simple modifier', () => {
        expect(
          p('b:popup m:autoclosable', { block: 'button2', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'autoclosable' } },
        ]);
      ...
      it('should extract block with modifier', () => {
        expect(
          p('b:popup m:autoclosable=yes', { block: 'button2', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'autoclosable' } },
          { block: 'popup', mod: { name: 'autoclosable', val: 'yes' } },
      ...
      it('should extract block with modifier and several values', () => {
        expect(
          p('b:popup m:theme=normal|action', { block: 'button2', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'theme' } },
          { block: 'popup', mod: { name: 'theme', val: 'normal' } },
      ...
      it('should extract block with several modifiers', () => {
        expect(
          p('b:popup m:theme m:autoclosable', { block: 'button2', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'theme' } },
          { block: 'popup', mod: { name: 'autoclosable' } },
      ...
      it('should extract block with several modifiers and several values', () => {
        expect(
          p('b:popup m:theme=normal|action m:autoclosable=yes', {
            block: 'button2',
            elem: 'tail',
          }),
        ).to.eql([
    ...
    describe('context is elem of current block', () => {
      ...
      it('should extract block with simple modifier', () => {
        expect(
          p('b:popup m:autoclosable', { block: 'popup', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'autoclosable' } },
        ]);
      ...
      it('should extract block with modifier', () => {
        expect(
          p('b:popup m:autoclosable=yes', { block: 'popup', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'autoclosable' } },
          { block: 'popup', mod: { name: 'autoclosable', val: 'yes' } },
      ...
      it('should extract block with modifier and several values', () => {
        expect(
          p('b:popup m:theme=normal|action', { block: 'popup', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'theme' } },
          { block: 'popup', mod: { name: 'theme', val: 'normal' } },
      ...
      it('should extract block with several modifiers', () => {
        expect(
          p('b:popup m:theme m:autoclosable', { block: 'popup', elem: 'tail' }),
        ).to.eql([
          { block: 'popup' },
          { block: 'popup', mod: { name: 'theme' } },
          { block: 'popup', mod: { name: 'autoclosable' } },
  ...
  describe('ctx', () => {
    ...
    describe('extract element from another block', () => {
      ...
      describe('context is elem', () => {
        it('should extract elem', () => {
          expect(
            p('b:button1 e:text', { block: 'button2', elem: 'control' }),
          ).to.eql([{ block: 'button1', elem: 'text' }]);
        });
      });
      ...
      describe('context is elem with same name', () => {
        it('should extract elem', () => {
          expect(
            p('b:button1 e:text', { block: 'button2', elem: 'text' }),
          ).to.eql([{ block: 'button1', elem: 'text' }]);
        });
      });
    });
