...
test('should include entity once if entity depends on itself when resolving deps', () => {
    var decl = [{ block: 'A' }],
        deps = [
            {
                entity: { block: 'A' },
...
test('should resolve dependency depending on another entity when resolving deps', () => {
    var decl = [{ block: 'A' }],
        deps = [
            {
                entity: { block: 'A' },
...
test('should allow dependency to depend on multiple entities when resolving deps', () => {
    var decl = [{ block: 'A' }],
        deps = [
            {
                entity: { block: 'A' },
